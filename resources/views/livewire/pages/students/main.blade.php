<div class="max-w-7xl">
    ...
    <div class="flex mt-4">
        <div>
            ...
            <input class="border-2 border-primary-100 w-64 mr-16" type="text" placeholder="الصف">
        </div>
        <div class="bg-primary-100 mr-5 w-11 h-11 flex items-center self-center p-2">
        ...
        <div>
            <button class="bg-primary-100 w-40 h-11 mr-10">
                متقدم
            </button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 mt-10 gap-x-8 gap-y-4">
        @for ($i = 0; $i < 12; $i++)
        <div class="border-2 border-secondary-200 w-80 h-20">
            <div class="p-3">
