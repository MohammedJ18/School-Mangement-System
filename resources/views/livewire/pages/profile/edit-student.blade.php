            ...
            <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                ...
                <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                    ...
                    <div class="flex items-center justify-between space-x-4">
                        <h1 class="text-xl font-medium text-gray-800 "> تعديل معلومات الطالب</h1>
                    ...
                    <form wire:submit.prevent="editStudent">
                        ...
                        <div class="mt-4">
                            <label class="block text-sm font-medium text-gray-700 text-right">صورة الطالب</label>
                            <div class="mt-1">
                        ...
                        <button type="submit"
                            class="text-white bg-primary-100 font-medium rounded-lg w-full text-sm px-5 py-2.5 mr-2 mb-2 mt-6">حفظ المعلومات</button>
                    </form>
